...
import { Moon, Sun, Monitor, Paintbrush, Globe } from "lucide-react";
...
export default function Settings() {
  ...
  const { apiData, unprocessedCount } = useRiskData();
        ...
        <header className="h-16 border-b border-border bg-card flex items-center justify-between px-6 z-10 shrink-0">
          <div className="flex items-center gap-4">
            <div className="w-[280px] shrink-0 text-center">
              <h1 className="text-card-foreground font-semibold">{t('settings.title')}</h1>
